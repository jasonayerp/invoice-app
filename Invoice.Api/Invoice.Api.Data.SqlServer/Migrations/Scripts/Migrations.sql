...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230719021843_InitialCreate')
BEGIN
...
BEGIN
    CREATE TABLE [dbo].[ClientAddresses] (
        ...
        [UtcUpdatedDate] DATETIME2 NULL DEFAULT ((NULL)),
        [UtcDeletedDate] DATETIME2 NULL DEFAULT ((NULL)),
        CONSTRAINT [PK_Addresses] PRIMARY KEY CLUSTERED ([ClientAddressId]),
...
BEGIN
    ...
    VALUES (N'20230719021843_InitialCreate', N'6.0.20');
END;
GO
