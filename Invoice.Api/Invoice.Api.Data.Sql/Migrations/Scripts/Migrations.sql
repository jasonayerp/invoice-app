...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230705202255_InitialMigration')
BEGIN
...
BEGIN
    CREATE TABLE [dbo].[Invoices] (
        ...
        CONSTRAINT [FK_Invoices_Addresses_BillFromAddressId] FOREIGN KEY ([BillFromAddressId]) REFERENCES [dbo].[Addresses] ([AddressId]) ON DELETE CASCADE,
        CONSTRAINT [FK_Invoices_Addresses_BillToAddressId] FOREIGN KEY ([BillToAddressId]) REFERENCES [dbo].[Addresses] ([AddressId]) ON DELETE CASCADE,
...
BEGIN
    CREATE TABLE [dbo].[InvoiceItems] (
        ...
        [UtcCreatedDate] datetime2 NOT NULL,
        [UtcUpdatedDate] datetime2 NULL,
        [UtcDeletedDate] datetime2 NULL,
...
BEGIN
    ...
    VALUES (N'20230705202255_InitialMigration', N'6.0.19');
END;
GO
