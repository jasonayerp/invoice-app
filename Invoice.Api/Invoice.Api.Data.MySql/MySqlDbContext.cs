...
public class MySqlDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ClientEntity>(entity =>
        {
            ...
            entity.Property(e => e.ClientId).HasColumnName("ClientId").HasColumnType("BIGINT").UseMySqlIdentityColumn();
            ...
            entity.HasIndex(e => e.Guid).HasDatabaseName("ix_clients_guid");
            entity.HasIndex(e => e.Name).IsUnique().HasDatabaseName("ux_clients_name");
